/* CPT Exam Simulator, Application Logic */

const ACCESS_CODE  = "CPT9000";
const EXAM_SECONDS = 9000;
const PASSING_PCT  = 62;
const STORAGE_KEY  = "cpt_exam_state_v1";
...
const DOMAIN_LABELS = {"phlebotomy_procedure_specimen_handling_and_processing": "Phlebotomy Procedure Specimen Handling and Processing", "tubes_colors_and_additives": "Tubes Colors and Additives", "order_of_draw_and_equipment_selection": "Order of Draw and Equipment Selection", "patient_id_and_patient_care": "Patient ID and Patient Care", "anatomy_and_physiology": "Anatomy and Physiology", "medical_terminologies_and_abbreviations": "Medical Terminologies and Abbreviations", "good_clinical_practice_safety_and_infection_control": "Good Clinical Practice Safety and Infection Control", "site_preparation": "Site Preparation"};  // maps domain key -> human-readable label for display
